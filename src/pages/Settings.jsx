...
import { Sun, Moon, Sparkles, Palette, Bell, User, Shield, MessageSquare, LayoutDashboard, Zap, Gamepad2, Upload, Building, Save } from 'lucide-react';
...
const Settings = () => {
  ...
  const handleSaveAllSettings = () => {
    ...
    toast({
      ...
      description: "Tu configuración de tema y apariencia se ha guardado correctamente.",
    });
  };
      ...
      <div className="p-8">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          >
                ...
                {themeOptions.map((option) => {
                  ...
                  return (
                    <Button
                      ...
                      className={`rounded-full transition-all flex items-center space-x-2 px-3 ${theme === option.value
                        ? (option.value === 'futuristic' || option.value === 'play' || option.value === 'nova'
            ...
            {(theme === 'futuristic' || theme === 'play' || theme === 'nova') && (
              <motion.div
          ...
          >
            <Button
              ...
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg px-8 py-6 rounded-2xl flex items-center gap-3 transition-all transform hover:scale-105 active:scale-95"
            >
              <Save className="w-6 h-6" />
              <span className="text-lg font-semibold">Guardar Cambios</span>
            </Button>
          </motion.div>
        </div>
      </div>
