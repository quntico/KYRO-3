...
import { UploadCloud, File, Calendar as CalendarIcon, Bell, X, PlusCircle, Trash2, DollarSign, Link as LinkIcon } from 'lucide-react';
        ...
        <div className="grid gap-6 py-6 max-h-[70vh] overflow-y-auto px-6 scrollbar-hide">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="phone" value={editingLead.phone} onChange={handleInputChange} className={theme === 'nova' ? 'bg-secondary/40' : ''} />
            </div>
            <div className="space-y-2">
