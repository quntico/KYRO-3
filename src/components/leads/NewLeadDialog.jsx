...
import { UploadCloud, File, X, PlusCircle, Trash2, DollarSign, Link as LinkIcon } from 'lucide-react';
...
const NewLeadDialog = ({ open, onOpenChange, onSubmit }) => {
  ...
  const handleSubmit = useCallback(() => {
    ...
    onSubmit({ company, name, position, email, phone, machines, quotations: files, notes, dynamic_quotation_url: dynamicQuotationUrl });
  }, [company, name, position, email, phone, machines, files, notes, dynamicQuotationUrl, onSubmit]);
        ...
        <div className="grid gap-6 py-6 max-h-[70vh] overflow-y-auto px-6 scrollbar-hide">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Teléfono de contacto" className={theme === 'nova' ? 'bg-white/5' : ''} />
            </div>
            <div className="space-y-2">
